...
export default function OfflineAccessPage() {
  ...
  return <section className="mx-auto w-full max-w-4xl space-y-4 pb-24">
    ...
    <p className="text-sm text-muted-foreground">Uploads run while InstructorOS is open with internet. Entries say “Synced” only after the server confirms them. Conflicts stay saved for review. Payments, booking changes, OTP and customer messages remain online-only.</p>
  </section>;
}
