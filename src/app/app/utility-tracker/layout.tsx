...
const navItems = [
  { href: "/app/utility-tracker", label: "Dashboard" },
  { href: "/app/utility-tracker/enter-data", label: "Enter Data" },
  { href: "/app/utility-tracker/data-tables", label: "Data Tables" },
  { href: "/app/utility-tracker/settings", label: "Settings" },
]
