...
const navItems = [
  { href: "/utility-tracker", label: "Dashboard" },
  { href: "/utility-tracker/enter-data", label: "Enter Data" },
  { href: "/utility-tracker/data-tables", label: "Data Tables" },
  { href: "/utility-tracker/settings", label: "Settings" },
]
